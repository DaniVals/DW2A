...
5. Haz que los usuarios administradores (usuarios con rol 1) puedan crear nuevas categorías y productos. 
...
class PedidosBase extends AbstractController
{
    ...
    public function anadir(SessionInterface $session, Request $request) {
        ...
        return $this->redirectToRoute('productos', ['id'=>$_POST('cat')]);
    }
